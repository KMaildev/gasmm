...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('view_failed_jobs'); ?></h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-uuid">
                                        <th class="title"> <?php print_lang('uuid'); ?>: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-connection">
                                        <th class="title"> <?php print_lang('connection'); ?>: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-queue">
                                        <th class="title"> <?php print_lang('queue'); ?>: </th>
                                        <td class="value">
                                            <span  data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("failed_jobs/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="queue" 
                                    ...
                                    <tr  class="td-payload">
                                        <th class="title"> <?php print_lang('payload'); ?>: </th>
                                        <td class="value">
                                            <span  data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("failed_jobs/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="payload" 
                                    ...
                                    <tr  class="td-exception">
                                        <th class="title"> <?php print_lang('exception'); ?>: </th>
                                        <td class="value">
                                            <span  data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("failed_jobs/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="exception" 
                                    ...
                                    <tr  class="td-failed_at">
                                        <th class="title"> <?php print_lang('failed_at'); ?>: </th>
