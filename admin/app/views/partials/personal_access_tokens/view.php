...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('view_personal_access_tokens'); ?></h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-tokenable_type">
                                        <th class="title"> <?php print_lang('tokenable_type'); ?>: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-tokenable_id">
                                        <th class="title"> <?php print_lang('tokenable_id'); ?>: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-token">
                                        <th class="title"> <?php print_lang('token'); ?>: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-abilities">
                                        <th class="title"> <?php print_lang('abilities'); ?>: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-last_used_at">
                                        <th class="title"> <?php print_lang('last_used_at'); ?>: </th>
                                        <td class="value">
