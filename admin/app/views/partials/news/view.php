...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('view_news'); ?></h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-photo">
                                        <th class="title"> <?php print_lang('photo'); ?>: </th>
                                        <td class="value"><?php Html :: page_img($data['photo'],400,400,1); ?></td>
                                    </tr>
                                    <tr  class="td-gallery">
                                        <th class="title"> <?php print_lang('gallery'); ?>: </th>
                                        <td class="value"><?php Html :: page_img($data['gallery'],400,400,100); ?></td>
                                    </tr>
                                    <tr  class="td-upload_date">
                                        <th class="title"> <?php print_lang('upload_date'); ?>: </th>
                                        <td class="value">
