...
class Failed_jobsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$page_title = $this->view->page_title = get_lang('failed_jobs');
	...
	function view($rec_id = null, $value = null){
		...
		if($record){
			$page_title = $this->view->page_title = get_lang('view_failed_jobs');
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
	...
	function add($formdata = null){
		...
		$page_title = $this->view->page_title = get_lang('add_new_failed_jobs');
	...
	function edit($rec_id = null, $formdata = null){
		...
		$page_title = $this->view->page_title = get_lang('edit_failed_jobs');
		if(!$data){
			$this->set_page_error();
		}
