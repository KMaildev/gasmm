...
class Personal_access_tokensController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$page_title = $this->view->page_title = get_lang('personal_access_tokens');
	...
	function view($rec_id = null, $value = null){
		...
		if($record){
			$page_title = $this->view->page_title = get_lang('view_personal_access_tokens');
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
	...
	function add($formdata = null){
		...
		$page_title = $this->view->page_title = get_lang('add_new_personal_access_tokens');
	...
	function edit($rec_id = null, $formdata = null){
		...
		$page_title = $this->view->page_title = get_lang('edit_personal_access_tokens');
		if(!$data){
			$this->set_page_error();
		}
